	...
	<div class="row my-4 boxShadow" style="border-radius: 8px">
		...
		<div class="col-md-6">
			<div class="align-items-baseline d-flex flex-column h-100 justify-content-between">
				<div class="">
					<h1 class="BebasFont">the most amazing title for the post goes here</h1>
					<p class="AliceFont TextOverflow"> It may not seem so, but the Mahindra SUV and Maruti hatchback
						have a similar
						story to tell may not seem so, but the Mahindra SUV and Maruti hatchback have a similar story to
						tell It may not seem so, but the Mahindra SUV and Maruti hatchback have a similar story to
						tell.... </p>
				</div>
...
<div class="row">
	<div class="col-md-7">
			...
			<div class="col-md-7">
				<div class="align-items-baseline d-flex flex-column h-100 justify-content-between">
					<div class="">
						...
						<p class="AliceFont TextOverflowFourLine"><?=$data[0]->detail?></p>
					</div>
					<button class="BorderBlueButton btn btn-sm mb-4" onclick="readMore('<?=$data[0]->id?>')" type="button">Read More</button>
		...
		<div class="row ">
			<div class="col-md-12 mb-4 px-0 boxShadow" style="border-radius: 8px">
				...
				<div class="px-3">
					<h1 class="BebasFont mt-3"><?=$data[1]->name?></h1>
					<p class="AliceFont TextOverflow"><?=$data[1]->detail?></p>
	...
	<div class="col-md-5">
		...
		<div class="row mx-0">
			<div class="col-md-12 mb-4 px-0 boxShadow" style="border-radius: 8px">
				<img src="<?= base_url() ?>uploads/<?=$data[3]->image?>" style="border-radius: 8px;height: 341px;"
					 class="w-100" alt="">

				<div class="px-3">
					<h1 class="BebasFont mt-3"><?=$data[3]->name?></h1>
					<p class="AliceFont TextOverflowFourLine"><?=$data[3]->detail?></p>
		...
		<div class="row mx-0">
			<div class="col-md-12 mb-4 px-0 boxShadow" style="border-radius: 8px;">
				<img src="<?= base_url() ?>uploads/<?=$data[4]->image?>" style="border-radius: 8px;height: 416px;"
					 class="w-100" alt="">
